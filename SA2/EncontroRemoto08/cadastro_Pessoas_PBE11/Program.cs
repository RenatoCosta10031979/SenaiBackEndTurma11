            ...
            switch(opcaoPf)
            {
               ...
               // endPf.Logradouro = "Avenida dos Poetas";
                ...
                novaPf.Endereco = endPf;
                    ...
                    // Instanciado objeto streamwriter para gerar um arquivio.txt
                    //Escrevemos dentro desse arquivo o nome do objeto de pessoa física
                    //StreamWriter sw =  new StreamWriter($"{novaPf.Nome}.txt"); 
                    //sw.WriteLine(novaPf.Nome);
                    //sw.close(); // encerramos  o objeto StreamirWriter
...
/*
                case "2";
                    ...
                    //usando o recurso com "using" conforme a documentação
    ...
    case "2":
        ...
        novaPj.Nome = " Carlos Drumond de Andrade";
        ...
        listPf<PessoaFisica> listPj = metodosPj.LerArquivo();
